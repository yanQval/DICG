...
from envs import SensorWrapper
...
def run(args):
    ...
    if args.mode == 'train':
        ...
        def train_sensor(ctxt=None, args_dict=vars(args)):
        ...
        train_sensor(args_dict=vars(args))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_agents', '-n', type=int, default=15)
    # Algo
